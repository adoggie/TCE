...
## 1.1 背景
 互联网技术飞速发展，各种基于internet的应用服务满天飞，每天都有新的创业idea层出不绝。互联网应用的特点在于推成出新的速度非常的快，往往一个业务创新需要快速的原型实现，所以传统的开发模式和技术不能满足互联网模式的要求。

在90年代或2k年初的时候，要驱动一个项目的设计、开发和实施，要求和成本还是比较的高，开发者必须除了熟练一到二门开发语言之外，还必须了解几种关系型数据库，c/c++/delphi/vb时代基本都是c/s的结构模式。之后几年开始了互联网模式，各种开发技术涌现，对开发者要求越来越低，只要能完成目标，技术不再是硬门槛 。 
